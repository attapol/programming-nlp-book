...
## ลิสต์ของดิกชันนารี
ลิสต์ของดิกชันนารีเป็นโครงสร้างข้อมูลอีกประเภทที่พบเห็นได้บ่อย เราอาจจะสงสัยกันว่าเมื่อไรกันที่เราต้องการเก็บรายการของสิ่งที่เก็บคู่ key value เอาไว้เยอะ ๆ ดิกชันนารีที่ถูกเก็บอยู่ในลิสต์มักจะเป็นดิกชันนารีที่มี key เหมือนกันทุกตัว ดิกชันนารีประเภทนี้มีหน้าที่คล้ายคลึงกับทูเปิล เช่น หากว่าเราใช้ลิสต์ของทูเปิลในการเก็บข้อความและผู้ส่งข้อความดังนี้
```python
messages = [
