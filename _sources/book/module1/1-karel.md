...
หลักสำคัญของการเขียนโปรแกรมไม่ใช่การจำคำสั่งให้ได้ แต่ว่าเป็นการนำคำสั่งมาประกอบรวมกันเพื่อสั่งให้เครื่องทำงานตามที่เราตั้งใจไว้ได้ เวลาเราได้โจทย์มาหนึ่งโจทย์ เช่น ดึงข้อมูลความคิดเห็น บนโลกโซเชียลลงมาเพื่อวิเคราะห์ว่าคนกำลังสนใจผู้สมัครผู้ว่าฯ คนใดมากที่สุด จะเห็นว่าเป็นโจทย์ที่ใหญ่มาก ไม่รู้เลยว่าจะเริ่มจากตรงไหนก่อน หลักการคิดเชิงคำนวณ (computational thinking) เป็นหลักการที่ทำให้เราแก้โจทย์การเขียนโปรแกรมเหล่านี้ ซึ่งประกอบไปด้วย 4 หลัก
...
ทักษะการคิดเชิงคำนวณดังตัวอย่างที่ยกขึ้นมานี้เป็นทักษะสำคัญที่สุดในการเขียนโปรแกรมซึ่งเราจะฝึกฝนกันในบทนี้โดยการใช้โปรแกรมที่ชื่อว่าแคเริล (Karel) {numref}`pattis1994karel`  ตัวแคเริลเป็นหุ่นยนต์ตัวเล็ก ๆ เดินไปเดินมาในโลกสี่เหลี่ยมเล็ก ๆ เราสามารถเขียนภาษาไพธอนให้แคเริลเดินไปตามคำสั่งของเรา เพื่อแก้โจทย์ต่าง ๆ ที่กำหนดได้ เราจะใช้แคเริลเป็นของเล่นในการฝึกทักษะการคิดเชิงคำนวณ ก่อนที่จะเริ่มเขียนเป็นภาษาไพธอนจริง ๆ กับโจทย์จริง ซึ่งจะต้องจำคำสั่งเพิ่มอีกมาก จุดประสงค์ของการเล่นกับแคเริลคือการฝึกทักษะการคิดแบบนักเขียนโปรแกรมโดยที่ไม่ต้องจำคำสั่งจำนวนมาก 

หุ่นยนต์แคเริลในโปรแกรมนี้สามารถเดินไปข้างหน้าได้ทีละก้าว แต่ไม่สามารถทะลุกำแพงได้ ถ้าเดินชนกำแพงโปรแกรมจะเกิดข้อผิดพลาด (error) ซึ่งก็คือแคเริลจะเสียและโปรแกรมจะต้องหยุดลง 
โจทย์ในโลกของแคเริลจะวางแคเริลไว้ที่จุดเริ่มต้น และกำหนดว่าโลกที่ให้มาขนาดเท่าไร มีกำแพงตรงไหนบ้าง และกระดิ่ง (beeper) อยู่ตรงไหนบ้าง ซึ่งแคเริลสามารถเก็บขึ้นมาหรือวางกระดิ่งตามจุดต่าง ๆ ได้ แต่ถ้าหากพยายามหยิบกระดิ่งในจุดที่ไม่มีกระดิ่งโปรแกรมก็จะเกิด error เช่นกัน คำสั่งที่ใช้ในการแก้โจทย์มีดังนี้
...
สมมติว่าเรามีโจทย์คือ ให้แคเริลไปหยิบกระดิ่งตรงหน้าเนินแล้วเดินข้ามเนินไปวางกระดิ่งที่คอลัมน์ที่ 5 ตามภาพข้างล่าง (ภาพซ้ายคือจุดเริ่มต้น ภาพขวาคือจุดมุ่งหมาย)
...
ลองดูตัวอย่างโจทย์ว่าแคเริลยืนอยู่บนถนนที่เป็นหลุมเป็นบ่อที่ต้องเอากระดิ่งลงไปอุดเพื่อทำให้ถนนเรียบ ๆ เดินง่าย สมมติว่าโลกที่แคเริลเริ่มต้นเป็นแบบภาพซ้ายด้านล่าง พอเรารันโปรแกรมโดยสมบูรณ์แล้วจะออกมาหน้าตาเหมือนกับภาพขวาล่าง
...
ตัวอย่าง ถ้าเรามีโจทย์ว่าให้แคเริลวางกระดิ่งบนแถวแรกให้เต็มแต่ยกเว้นริมซ้ายสุด และริมขวาสุด โดยที่จุดเริ่มต้นอยู่ที่มุมซ้ายล่างและแคเริลหันไปทางตะวันออก
...
เราจะเห็นแพทเทิร์นว่าแคเริลจะต้องก้าวและวางกระดิ่งทั้งหมด 6 ครั้งด้วยกัน และก็ก้าวอีกก้าวเพื่อให้จบที่ริมขวาสุด ดังนี้
...
|    `beepers_present()`    |     `no_beepers_present()`    |     มี  กระดิ่งตรงที่แคเริลยืนอยู่มั้ย    |
...
|     `beepers_in_bag()`     |     `no_beepers_in_bag()`     |    แคเริลมีกระดิ่งในกระเป๋ามั้ย     |
...
ตัวอย่างการใช้ `if` ต่อไปจะเป็นตัวอย่างที่ซับซ้อนขึ้นมาอีกขั้น สมมติว่าเราต้องการให้แคเริลวางกระดิ่งในช่องที่ไม่มีกระดิ่งอยู่ก่อนแล้ว และให้เก็บกระดิ่งถ้าเกิดว่าในช่องนั้นมีกระดิ่งอยู่ก่อนแล้ว เพื่อความง่ายเราจะทำเฉพาะแถวล่างสุดเท่านั้น และแคเริลยืนอยู่แถวล่างสุดอยู่แล้ว 
...
เราจะเริ่มแก้ปัญหานี้โดยการย่อยโจทย์และการสังเกตแพทเทิร์นว่า ทุกช่องเราจะทำกระบวนการเดียวกันทั้งหมด เพราะฉะนั้นเราสามารถเขียนฟังก์ชันแยกออกมาเพื่อแก้โจทย์ย่อยในการเก็บและวางกระดิ่งดังนี้
...
สมมติว่าเราต้องการให้แคเริลเอากระดิ่งที่อยู่รอบรั้วออกไปให้หมด ดังตัวอย่างดังนี้
```{figure} img/boolean-remove-fence.png
ซ้าย: จุดเริ่มต้น
ขวา: จุดมุ่งหมาย
```
เราสามารถสังเกตหาแพทเทิร์นได้ว่าการเก็บกระดิ่งแต่ละข้างมีวิธีการเหมือนกันทุกประการ เราสามารถย่อยโจทย์ออกมาเป็นฟังก์ชันที่เก็บกระดิ่งของหนึ่งข้าง และใช้ฟังก์ชันนั้นซ้ำ ๆ 
```python
def main():
    for i in range(4):
        remove_one_side()
...
การใช้ control flow ในการเขียนโปรแกรมเป็นเครื่องมือที่สำคัญมากในการแก้ปัญหา โดยเฉพาะการใช้ `for` loop และ `while` loop ในการวนรันโค้ดซ้ำ ๆ และการใช้ `if` ในการเลือกว่าจะรันโค้ดใดในเงื่อนไขใด การใช้ control flow ชี้ให้เห็นว่าเราสามารถแก้ปัญหาที่ซับซ้อนได้โดยการย่อยโจทย์ การสังเกตแพทเทิร์น การคิดแบบนามธรรม และการออกแบบอัลกอริธึม ซึ่งเป็นทักษะที่สำคัญในการเขียนโปรแกรมที่ดี
