...
### การกำจัดแถวที่มีข้อมูลที่หายไป หรืิอเติมค่าให้กับข้อมูลที่หายไป
...
#### 2. เลือกด้วยลิสต์ของชื่อคอลัมน์ หรือ ลิสต์ของชื่อแถว เช่น
```python
airline_reviews_small.loc[[5, 6, 7], ['Rating', 'Review']]
```
คำสั่งข้างต้นเลือกแถวที่ 5, 6, และ 7 และคอลัมน์ Rating และ Review

#### 3. เลือกด้วยช่วงของชื่อคอลัมน์ หรือ ชื่อแถว โดยใช้เครื่องหมาย : เป็นตัวคั่นระหว่างจุดเริ่มต้นไปถึงจุดหมาย เช่น 
