...
- ผู้อ่านเรียนรู้ว่าตัวแปรคืออะไร และมีกี่ชนิด
- ผู้อ่านเรียนรู้การประกาศและให้ค่ากับตัวแปร เพื่อใช้เก็บข้อมูลที่เป็นตัวเลข บูลีน และสตริง
- ผู้อ่านสามารถเขียนฟังก์ชันที่มีหลายพารามิเตอร์ได้
- ผู้อ่านสามารถใช้วงวน `for` กับวงวน `while` ร่วมกับตัวแปรอื่น ๆ ได้
- ผู้อ่านได้เรียนรู้การใช้เมท็อดของสตริงที่มักพบได้บ่อย
```
