# โจทย์: Data type
เวลาเราใช้โครงสร้างข้อมูลหลายรูปแบบมาประกอบกัน เราต้องคำนึงถึงประเภทของข้อมูลตลอดเวลาที่เขียนโค้ด ในแต่ละข้อให้บอกว่าโปรแกรมคืนค่าออกมาเป็นโครงสร้างข้อมูลประเภทใด เช่น ลิสต์ของสตริง ลิสต์ของทูเปิล (สตริง, สตริง, เลขจำนวนเต็ม), ดิกชันนารี (สตริง → เลขจำนวนเต็ม) เป็นต้น
