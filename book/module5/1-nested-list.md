# บทที่ 5 </br> โครงสร้างข้อมูลแบบซ้อนใน

```{admonition} จุดมุ่งหมายของบทนี้
- ผู้อ่านสามารถอธิบายได้ว่าโครงสร้างข้อมูลแบบซ้อนในนั้นมีลักษณะอย่างไร
- ผู้อ่านสามารถเลือกใช้โครงสร้างข้อมูลแบบซ้อนในให้เหมาะสมกับงานได้
- ผู้อ่านสามารถอ่านและรู้วิธีเข้าถึงข้อมูลที่ถูกจัดเก็บในรูปแบบโครงสร้างข้อมูลแบบซ้อนในได้
```
